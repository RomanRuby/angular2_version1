    ...
    UpdateRoleComponent.prototype.save = function () {
        ...
        for (var i = 0; i < this.policyRuleDtoWithDeleteFunction.length; i++) {
            if (this.policyRuleDtoWithDeleteFunction[i].isDelete == false) {
                policyRulesArrays.push(new role_1.PolicyRule(this.policyRuleDtoWithDeleteFunction[i].verbs.split(','), this.policyRuleDtoWithDeleteFunction[i].apiGroups.split(','), this.policyRuleDtoWithDeleteFunction[i].resources.split(','), this.policyRuleDtoWithDeleteFunction[i].resourceNames.split(',')));
            }
            else {
                this.policyRuleDtoWithDeleteFunction =
